...
- The number of steps that the script runs through is ste with the *steps* parameter in the *[run]* section of the config.
...
- The script must run through the whole simulation (or number specified in the *steps* paramter) first, then the data is collated for use in the GUI.
